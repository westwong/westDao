...
public abstract class OperationBase {
    ...
    protected <T> Predicate[] generatePredicates(CriteriaBuilder cb, Root<T> root, T entity) {
        if (!entity.getClass().isAnnotationPresent(jakarta.persistence.Entity.class)) {
        ...
        for (String attributeName : entityManager.getMetamodel().entity(entity.getClass()).getDeclaredAttributes()
                .stream()
