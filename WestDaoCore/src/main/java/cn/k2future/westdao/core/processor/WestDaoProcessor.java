...
public class WestDaoProcessor extends AbstractProcessor {
        ...
        private void generateMethods(TypeElement typeElement, String prefix) throws IOException {
                ...
                String originalPkgName = ClassName.get(typeElement).packageName();
                if (originalPkgName.startsWith("package ")) {
                    originalPkgName = originalPkgName.replace("package ", "").trim();
                }
                String generatedPkgName = originalPkgName + ".generated";

                ClassName parentClassName = ClassName.get(originalPkgName, className);
                ClassName childClassName = ClassName.get(generatedPkgName, newClassName);
                ...
                TypeSpec.Builder builder = TypeSpec.classBuilder(newClassName)
                                ...
                                .addAnnotation(AnnotationSpec.builder(javax.annotation.processing.Generated.class)
                                        .addMember("value", "$S", WestDaoProcessor.class.getCanonicalName())
                                        .addMember("comments", "$S", "Source code generated by WestDaoProcessor")
                                        .build())
                ...
                JavaFile javaFile = JavaFile.builder(generatedPkgName, generatedClass)
                        .build();
