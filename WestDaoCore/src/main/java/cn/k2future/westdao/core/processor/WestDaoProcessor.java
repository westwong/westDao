...
public class WestDaoProcessor extends AbstractProcessor {
        ...
        private void generateMethods(TypeElement typeElement, String prefix) throws IOException {
                ...
                ClassName parentClassName = ClassName
                                .get(processingEnv.getElementUtils().getPackageOf(typeElement).toString(), className);
                ClassName childClassName = ClassName.get(
                                processingEnv.getElementUtils().getPackageOf(typeElement).toString(), newClassName);
                ...
                for (Element enclosedElement : typeElement.getEnclosedElements()) {
                        if (enclosedElement instanceof VariableElement) {
                                ...
                                parentConstructorBuilder.addStatement("super.$N(parent.$N())", setterMethodName,
                                                getterMethodName(fieldType, capitalizedFieldName));
                        }
                }

                MethodSpec parentConstructor = parentConstructorBuilder.build();

                FieldSpec entityManager = FieldSpec
                                .builder(OperationManager.class, "operationManager", Modifier.PRIVATE, Modifier.STATIC)
                                .build();
                ...
                for (Element enclosedElement : typeElement.getEnclosedElements()) {
                        if (enclosedElement instanceof VariableElement) {
                                ...
                                String capitalizedFieldName = fieldName.substring(0, 1).toUpperCase()
                                                + fieldName.substring(1);
                                String setterMethodName = "set" + capitalizedFieldName;
                                parseParentBuilder.addStatement(String.format("parent.%s(child.%s())", setterMethodName,
                                                getterMethodName(fieldType, capitalizedFieldName)));
                        }
                }
                ...
                MethodSpec saveMethod = MethodSpec.methodBuilder("save")
                                ...
                                .addStatement(String.format("return %s.operationManager.<%s>save(%s.parseParent(this))",
                ...
                MethodSpec deleteByMethod = MethodSpec.methodBuilder("deleteById")
                                ...
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>deleteById(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                // delete
                MethodSpec deleteAllMethod = MethodSpec.methodBuilder("deleteAll")
                                ...
                                .addAnnotation(Override.class)
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>deleteAll(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec findByIdMethod = MethodSpec.methodBuilder("findById")
                                ...
                                .addAnnotation(Override.class)
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>findById(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec updateByIdMethod = MethodSpec.methodBuilder("updateById")
                                ...
                                .addAnnotation(Override.class)
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>updateById(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec findAllMethod = MethodSpec.methodBuilder("findAll")
                                ...
                                .addAnnotation(Override.class)
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>findAll(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec findOneMethod = MethodSpec.methodBuilder("findOne")
                                ...
                                .addAnnotation(Override.class)
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>findOne(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                // page
                MethodSpec pageMethod = MethodSpec.methodBuilder("page")
                                ...
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>page(%s.parseParent(this), page)",
                                                newClassName, className, newClassName))
                                .build();
                // count
                MethodSpec countMethod = MethodSpec.methodBuilder("count")
                                ...
                                .addAnnotation(Override.class)
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>count(%s.parseParent(this))",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec deleteAllBuilderMethod = MethodSpec.methodBuilder("deleteAll")
                                ...
                                .addParameter(ParameterizedTypeName.get(
                                                ClassName.get("cn.k2future.westdao.core.wsql.builder", "JpqlBuilder"),
                                                parentClassName), "builder")
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>deleteAll(%s.parseParent(this), builder)",
                                                newClassName, className, newClassName))
                                .build();
                // deleteAll method using builder
                MethodSpec updateBuilderMethod = MethodSpec.methodBuilder("update")
                                ...
                                .addParameter(ParameterizedTypeName.get(
                                                ...
                                                parentClassName), "builder")
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>update(%s.parseParent(this), builder)",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec findAllBuilderMethod = MethodSpec.methodBuilder("findAll")
                                ...
                                .addParameter(ParameterizedTypeName.get(
                                                ...
                                                parentClassName), "builder")
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>findAll(%s.parseParent(this), builder)",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec findOneBuilderMethod = MethodSpec.methodBuilder("findOne")
                                ...
                                .addParameter(ParameterizedTypeName.get(
                                                ...
                                                parentClassName), "builder")
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>findOne(%s.parseParent(this), builder)",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec pageBuilderMethod = MethodSpec.methodBuilder("page")
                                ...
                                .addParameter(ParameterizedTypeName.get(
                                                ...
                                                parentClassName), "builder")
                                .addStatement(String.format(
                                                "return %s.operationManager.<%s>page(%s.parseParent(this), page, builder)",
                                                newClassName, className, newClassName))
                                .build();
                ...
                MethodSpec countBuilderMethod = MethodSpec.methodBuilder("count")
                                ...
                                .addParameter(ParameterizedTypeName.get(
                                                ClassName.get("cn.k2future.westdao.core.wsql.builder", "JpqlBuilder"),
                                                parentClassName), "builder")
                                .addStatement(String.format("return %s.operationManager.<%s>count(builder)",
